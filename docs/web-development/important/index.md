...
This section is the common frontend engineering entry point for topics that apply across multiple stacks.

Use the technology-specific sections for framework details, and use this section when you want the complete study path for a shared engineering concern.
...
- [Backend for FE (BFF)](./backend-for-fe-bff.md)
- [SOLID](./solid.md)
