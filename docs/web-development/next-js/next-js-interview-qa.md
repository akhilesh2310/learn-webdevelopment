---
title: Next.js Interview Q&A
sidebar_position: 2
---

# Next.js Interview Q&A

Related canonical pages: [JWT & CSRF](../security-auth/jwt-csrf-token-storage.md), [Security Headers](../security-auth/security-headers.md).
