...
3. [JWT & CSRF](./jwt-csrf-token-storage.md)
4. [Security Headers](./security-headers.md)
5. [iFrame Protection](./iframe-clickjacking-protection.md)
...
- Token storage and CSRF tradeoffs live in [JWT & CSRF](./jwt-csrf-token-storage.md).
- CSP, HSTS, X-Frame-Options, and related headers live in [Security Headers](./security-headers.md).
- Clickjacking and frame protection live in [iFrame Protection](./iframe-clickjacking-protection.md).
