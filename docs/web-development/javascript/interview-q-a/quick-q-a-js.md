...
## **🟦 TypeScript Interview Preparation – Detailed Concepts, Questions & Answers**
...
**Q: When should you use explicit type annotations?**

**A:** When the type is not obvious, or for public API clarity.
...
**Q: How do you define a typed object in TypeScript?**

interface User \{  
  name: string;  
  age: number;  
\}  
const user: User \= \{ name: 'Akhilesh', age: 33 \};
...
* `interface` is better for extending.

* `type` is more flexible (can define unions).
...
**Q: How does type narrowing work with union types?**
...
**Q: How do you export and import modules in TypeScript?**
...
**A:** It configures how the TS compiler compiles your code.
